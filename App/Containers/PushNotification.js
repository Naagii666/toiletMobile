...
import { onSaveFirebaseToken } from '../TLogin/product/ProductsActions'
...
class PushNotification extends Component {
    ...
    async componentDidMount() {
        ...
        OneSignal.getPermissionSubscriptionState((sState) => {
            //alert(JSON.stringify(sState))
            //console.log(sState)
            this.props.onSaveFirebaseToken(sState.userId)
        });
    ...
    onReceived(notification) {
        this.props.navigate({ routeName: 'MonitorMaps' })
...
export default connect(
  ...
  dispatch => {
    return {
      onSaveFirebaseToken: bindActionCreators(onSaveFirebaseToken, dispatch),
